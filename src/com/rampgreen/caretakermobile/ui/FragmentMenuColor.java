...
import com.rampgreen.caretakermobile.adapter.ExpandableListAdapter;
...
public class FragmentMenuColor extends SherlockFragment
{
	...
	public void onActivityCreated(Bundle savedInstanceState)
	{
		...
		// for (int i = 0; i < 4; i++) {
		// adapter.add(new SampleItem(slider_menu_text[i],
		// slider_menu_icon[i]));
		// }
	...
	public void init()
	{
		...
		listView.setOnChildClickListener(new OnChildClickListener()
		{
			...
			{
				ExpandableListAdapter ad = (ExpandableListAdapter) parent
						.getExpandableListAdapter();
				Profile profile = (Profile) ad.getChild(groupPosition,
						childPosition);
				// AppSettings.setPreference(AccountListActivity.this, null,
				// AppSettings.ACCOUNT_TOKEN, profile.getAccountToken());
				// AppSettings.setPreference(AccountListActivity.this, null,
				// AppSettings.PROFILE_ID, profile.getProfileID());
				// Intent localIntent = new Intent(AccountListActivity.this,
				// FragmentChangeActivity.class);
				// localIntent.putExtra(Constants.CALLING_ACTIVITY_TYPE,
				// Constants.CALLING_ACTIVITY_ACCOUNTLISTACTIVITY);
		...
		listView.setOnGroupClickListener(new OnGroupClickListener()
		{
			...
			//
			// // AppSettings.setPreference(AccountListActivity.this, null,
			// AppSettings.ACCOUNT_NAME, acName);
